...
const PaymentMethod = () => {
  return (
    <div className="flex gap-x-[30px]">
      <div className="px-10 py-[25px] border border-primary flex items-center justify-center relative w-[132px] h-[102px] shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)] rounded-2xl ">
        <img src="./Paypal.png" alt="paypal.png" className=""></img>
      ...
      <div className="px-10 py-[25px] flex items-center justify-center relative w-[132px] h-[102px] shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)] rounded-2xl ">
        <img src="./PayApp.png" alt="paypapp.png" className=""></img>
      </div>
    </div>
  );
};
